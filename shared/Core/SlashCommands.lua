...
local function Print(message)
    DEFAULT_CHAT_FRAME:AddMessage("|cffd6a84b__DISPLAY_NAME__:|r " .. message)
end
...
function SlashCommands:Initialize()
    SLASH___COMMAND_KEY__1 = "__LONG_COMMAND__"
    SLASH___COMMAND_KEY__2 = "__SHORT_COMMAND__"
    SlashCmdList.__COMMAND_KEY__ = function(input)
        self:Handle(input)
    end
end
