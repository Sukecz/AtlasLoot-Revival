...
function MainWindow:CreateTitle(parent)
    ...
    icon:SetTexture("Interface\\AddOns\\__ADDON_ID__\\assets\\minimap-icon.tga")
...
function MainWindow:CreateSidebar(parent)
    ...
    dungeonButton.arrow:SetTexture("Interface\\AddOns\\__ADDON_ID__\\assets\\dropdown-chevron.tga")
...
function MainWindow:CreateMap(parent)
    ...
    floorButton.arrow:SetTexture("Interface\\AddOns\\__ADDON_ID__\\assets\\dropdown-chevron.tga")
    ...
    for index = 1, MAX_MAP_PINS do
        ...
        marker:SetTexture("Interface\\AddOns\\__ADDON_ID__\\assets\\boss-marker.tga")
        pin.marker = marker
        local ring = pin:CreateTexture(nil, "OVERLAY")
        ring:SetSize(24, 24)
        ring:SetPoint("CENTER")
        ring:SetTexture("Interface\\AddOns\\__ADDON_ID__\\assets\\boss-marker-ring.tga")
...
function MainWindow:Create()
    ...
    local frame = CreateFrame("Frame", "__ADDON_ID__MainFrame", UIParent)
