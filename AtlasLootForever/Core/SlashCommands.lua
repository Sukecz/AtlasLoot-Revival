...
local function Print(message)
    DEFAULT_CHAT_FRAME:AddMessage("|cffd6a84bAtlasLoot Forever:|r " .. message)
end
...
function SlashCommands:Initialize()
    SLASH_ATLASLOOTFOREVER1 = "/atlaslootforever"
    SLASH_ATLASLOOTFOREVER2 = "/alf"
    SlashCmdList.ATLASLOOTFOREVER = function(input)
        self:Handle(input)
    end
end
